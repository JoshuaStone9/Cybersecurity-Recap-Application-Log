# Identity & Access Management (Recap & Application)
...
- **PowerShell** – Access audit automation.

## Practical Application / Lab Work
- Configured IAM policies in AWS restricting S3 access to specific roles.  
- Simulated account lifecycle management with automatic deprovisioning.  
- Tested MFA enforcement and conditional access rules.

## SBS Relevance
IAM directly supports SBS’s security posture by controlling:  
- Who can view or edit customer claim data.  
...
## Next Steps
-  Complete AWS and Azure IAM hands-on labs.  
-  Learn automation with PowerShell and Terraform.  
-  Study Zero Trust identity models.
