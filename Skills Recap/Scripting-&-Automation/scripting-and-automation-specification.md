# Scripting & Automation (Recap & Application)
...
- **Security Automation:** Triggering alerts, patching, and reporting.

## Tools Used
- **Python / Boto3 SDK** – AWS automation scripting.  
- **PowerShell** – Windows automation and auditing.  
...
## SBS Relevance
SBS can leverage scripting to:  
- Automatically check for misconfigurations or unencrypted data.  
- Schedule compliance checks for GDPR reporting.  
- Streamline backups, logging, and report generation.
