# Penetration Testing (Recap & Application)
...
- **Burp Suite** – Web-application testing and request interception.  
- **OWASP ZAP** – Automated web vulnerability scanning.  
- **TryHackMe / Hack The Box** – Platforms for ethical hacking labs and scenario-based exercises.

## Practical Application / Lab Work
- Completed TryHackMe rooms including *“Pre-Security,” “Network Services,”* and *“OWASP Top 10.”*  
- Conducted a mock penetration test against a vulnerable VM (Metasploitable 2) to identify exploitable services and test mitigation steps.  
- Wrote a short test report outlining findings, risk levels (CVSS), and recommended fixes.  
- Experimented with automated reporting templates and Python scripts to collect scan results.

## SBS Relevance
SBS Insurance Services manages sensitive personal and financial data through web portals and cloud systems.  
Penetration testing skills are directly relevant to:
- Identifying vulnerabilities in **customer portals** and **API endpoints**.  
- Testing **cloud misconfigurations** (e.g., S3 exposure, IAM mis-roles).  
- Validating security controls that protect **claim and fraud-detection data**.  
...
- Improve automated reporting using Python and Markdown.

## Next Steps
-  Complete TryHackMe “Intermediate Penetration Testing” path.  
-  Practise exploit development and post-exploitation scenarios.  
-  Learn more about red-team vs blue-team collaboration.  
-  Continue mapping vulnerabilities to real business impact for future roles.
